                ...
                script{
                    if (env.rollback == 'false'){
                        docker.withRegistry('https://registry.hub.docker.com', 'docker-hub-credentials'){
                            ...
                            front = docker tag dkhan20/frontend:latest dkhan20/frontend:${app_version}
                            front.push("${env.app_version}")
                            back = docker tag dkhan20/backend:latest dkhan20/backend:${app_version}
                            back.push("${env.app_version}")
                            db = docker tag dkhan20/database:latest dkhan20/backend:${app_version}
