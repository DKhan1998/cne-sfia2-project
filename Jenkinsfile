                ...
                script{
                    if (env.rollback == 'false'){
                        ...
                        sh """
                            ...
                            sudo -tt -o "StrictHostKeyChecking=no" -E MYSQL_ROOT_PASSWORD=${env.MYSQL_ROOT_PASSWORD} DB_PASSWORD=${env.DB_PASSWORD} TEST_DATABASE_URI=${env.TEST_DATABASE_URI} SECRET_KEY=${env.SECRET_KEY} docker-compose build
